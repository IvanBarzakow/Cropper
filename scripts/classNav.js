...
App = function(){
	...
	return {
		...
		draw	:function(){
			...
			canvas2Ctx = canvas.getContext('2d');
			canvas3Ctx = canvas.getContext('2d');
			grd = canvasCtx.createLinearGradient(0,0,170,0);
			grd.addColorStop(0,"#64e4bb");
			grd.addColorStop(1,"#4992bd");
			grd2 = canvasCtx.createLinearGradient(0,0,170,0);
			grd2.addColorStop(0,"#ffad43");
			grd2.addColorStop(1,"#f5e663");

			canvasCtx.strokeStyle = grd;
			canvasCtx.lineWidth = 10;
			canvasCtx.strokeRect(0,0,200,200);
			canvasCtx.shadowColor ='#64e4bb';
			canvasCtx.shadowBlur = 2;
			canvasCtx.shadowOffsetY = 0;
			canvasCtx.shadowOffsetX = 0;

			canvas2Ctx.fillStyle = grd2;
			canvas2Ctx.strokeStyle = '#000';
			canvas2Ctx.lineWidth = 2;
			canvas2Ctx.lineCap = 'round';
			canvas2Ctx.lineJoin = 'bevel';
			canvas2Ctx.setLineDash([2, 3]);
			canvas2Ctx.font = '45px sans-serif';
			canvas2Ctx.textAlign='center';
			canvas2Ctx.fillRect(5,5,190,190);	
			canvas2Ctx.strokeText('BOX', 100,100);	
			canvas2Ctx.clearRect(0,0,60,60);	

			canvas3Ctx.beginPath();
			canvas3Ctx.moveTo(230,10);
			canvas3Ctx.lineTo(280,10);
			canvas3Ctx.lineTo(250, 140);
			canvas3Ctx.closePath();
			canvas3Ctx.stroke();
		},
